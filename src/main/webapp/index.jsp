...
<head>
    ...
    <style>
        ...
        :root {
            ...
            --shadow-hover: 0 12px 48px rgba(44, 62, 80, 0.10);
        ...
        * {
        ...
        .btn-primary:hover {
            ...
            box-shadow: 0 8px 24px rgba(108, 139, 159, 0.30);
        }
        .btn-secondary {
        ...
        .search-wrap:focus-within {
            border-color: var(--accent);
            background: #fff;
            box-shadow: 0 0 0 4px rgba(108, 139, 159, 0.10);
        }
        .search-wrap input {
            border: 0;
            background: transparent;
        ...
        .hero .badge {
            ...
            background: rgba(108, 139, 159, 0.20);
            color: #d5e1e8;
            padding: 4px 16px;
            border-radius: 999px;
            font-weight: 600;
        ...
        <div class="container header-inner">
            ...
            <div style="display:flex;align-items:center;gap:10px;">
                ...
                <div class="header-actions">
                    ...
                    <button class="icon-btn" title="Wishlist" aria
